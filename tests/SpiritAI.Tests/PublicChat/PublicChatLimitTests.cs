...
{
    private const string Public = "/v1/public/main/responses";
    private const string Slow = "/v1/public/main/responses/slow";
    ...
    public async Task LimitsNothingButThePublicRoute()
    {
        ...
        for (var i = 0; i < 5; i++)
        {
            var signedIn = await client.GetAsync("/v1/main/responses", TestContext.Current.CancellationToken);
            ...
            .ConfigureWebHost(web => web
                ...
                .Configure(app =>
                {
                    ...
                    app.UseEndpoints(endpoints =>
                    {
                        ...
                        endpoints.MapGet("/v1/main/responses", () => Results.Ok("private"));
