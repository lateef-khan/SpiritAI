...
/**
 * The dated rule on its own, for a thread that already draws its own messages.
 *
 * `DaySeparator` below renders a whole conversation — bubbles, text and all — which suits the
 * gallery demo but not a `ThreadPrimitive.Messages` list, where assistant-ui owns the messages.
 * This is the same rule markup, liftable to sit above one message.
 */
