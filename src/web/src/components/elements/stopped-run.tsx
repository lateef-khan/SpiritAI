  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {/* "Retry", not the shipped "Continue": AgentCore has no resume endpoint, so the only
              thing this can do is run the turn again from the top. Saying "Continue" would promise
              the half-written answer is kept, and it is not. */}
          Retry
