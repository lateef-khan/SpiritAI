...
/// <param name="CallId">The chat the reply is on. Not shown to the visitor; named in the log when the send fails.</param>
/// <param name="StaffName">Who replied, as the visitor sees the name above the message.</param>
/// <param name="Text">The words.</param>
public sealed record HandoffReplyMail(string To, string CallId, string StaffName, string Text);
