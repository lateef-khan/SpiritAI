...
/// </summary>
/// <param name="Position">Where the chat stands in the line, one for the front.</param>
...
public sealed record RequestHumanAnswer(int Position, int StaffOnline, string Note);
