...
public interface IHandoffStore
{
    ...
    /// </returns>
    Task<int?> PositionAsync(string callId, CancellationToken cancellationToken);
    ...
    Task<Handoff?> OpenAsync(string callId, CancellationToken cancellationToken);
    ...
    Task<Handoff?> LatestAsync(string callId, CancellationToken cancellationToken);
    ...
    Task<bool> DoneAsync(string callId, CancellationToken cancellationToken);
