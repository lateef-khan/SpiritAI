...
A customer's contact record lives on PURCHASE: PURCHASEDBY, ADDRESS, CITY, STATE, ZIP,
PHONE, PHONE2, EMAIL. When the question is who owns a machine or how to reach them, read
those columns and give them. find_units and get_service_history_by_sn return the same
record on every row.
