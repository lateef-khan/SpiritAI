...
/// <summary>
/// Points <see cref="CallStub"/> at AgentCore's <c>agentcore.call</c>, and keeps EF's hands off it.
/// </summary>
/// <remarks>
...
internal sealed class CallStubConfiguration : IEntityTypeConfiguration<CallStub>
{
    public void Configure(EntityTypeBuilder<CallStub> builder)
    {
        ...
        builder.ToTable("call", "agentcore", table => table.ExcludeFromMigrations());
